    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-green-600 text-white hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
                day_today:
                    "!bg-slate-800 text-white dark:bg-slate-800 dark:text-slate-50",
                day_disabled: "text-white bg-red-500 dark:text-slate-400",
                day_outside:
